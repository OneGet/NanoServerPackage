@{
  ...
  Description = 'A PackageManagement provider to  Discover, Save and Install Nano Server Packages on-demand'
	...
	VariablesToExport = "*"
  FunctionsToExport = @('Install-NanoServerPackage',
                          'Find-NanoServerPackage',
                          'Save-NanoServerPackage')
    FormatsToProcess = 'NanoServerPackage.Format.ps1xml'
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU/R1pwsbIWPF4HnEpR+1Zj5lD
# epKgghWCMIIEwzCCA6ugAwIBAgITMwAAAJb6gDHvN2RGRQAAAAAAljANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFPtx
# aEnMvssm/yGMRzmZQ4WWih3uMFAGCisGAQQBgjcCAQwxQjBAoBaAFABQAG8AdwBl
# AHIAUwBoAGUAbABsoSaAJGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbS9Qb3dlclNo
# ZWxsIDANBgkqhkiG9w0BAQEFAASCAQBGfSeBs3zO1cHrliTRKFIO3/JXU9myppwe
# yODuUIxytNlJBvukDFe5tu34aKXm5uAhoZlE8xzteIxnyOVYFekHLBHCpZK/qKK0
# dJUdwdSaihIJyh3LXElp5QsQLpV85DHoK723v79uxc9wdtFAuN8t9lqyUax44C0g
# TO3G7jwCEPlFiIEAtxrft1919ZU+1TDqo7p7NCQ5+wHQCKnthJJIyM4OxnUUAk3f
# 5qsj19GZHX9SSm8OZvr9+yiNRc21qtrVUbnst63s09+5xRVrbdDvNgrxPzwGbT3v
# +qW98aIjMZ/BYDqdQCvCKeLy+Ve1ytWdZseenTOcTKYKg7DYvvUYoYICKDCCAiQG
...
# hkiG9w0BCQQxFgQUC4u+riKWZ3p1D4mJuxdrkM13XnUwDQYJKoZIhvcNAQEFBQAE
# ggEAXBW0hZnEn/GKwJ99/WhNx29K3hOyNyWuqNZsVXaVZsrS0tC3rLRXriElTd64
# hxYhAzIvC4mnzg2a9gCgG5Bv8GKwJP8M7h33ddw3kYqPHCMlIApwmSNgPDuFeDg5
# FjGEnACprNdR6R0booQ4ut722KVsAkl3fQIMDdmL1TIk+GyzDIsp00GbWdUquHxG
# 7utdzUD+Ko94+D++9q5pZTKXBNqmzgXc+wO7dzWnWYP/pLasiHAUB8ymS9CRExmi
# XtLtaSzjz5UNmzN2msqlRt0yiZL7Wbkoyom/3s7p1rMX9/a1ZcQaXRTNLGjGR+tx
# GkOXKcgUuFW+/7A5HbPrHomU9A==
